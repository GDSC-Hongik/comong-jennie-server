...
from .views import post_detail,post_create,grade_post ,majorboard_view,sub_post , prof_post , main_view , join_post_list,join_post_detail,join_post_create,scrap_board,comment_detail,post_likes
app_name = "Community"
